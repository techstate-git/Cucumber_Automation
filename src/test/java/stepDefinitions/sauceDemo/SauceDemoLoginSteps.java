...
public class SauceDemoLoginSteps {
    ...
    @And("the user is enter wrong password")
    public void the_user_is_enter_wrong_password(){
        sauceDemoLoginPage.enterPassword("WRONGPASSWORD");
    }

    @Then("the user is not able to login")
    public void the_user_is_not_able_to_login(){
        sauceDemoLoginPage.errorMessageIsDisplayed();
    }
